  ...
  function u(e, t, n, i) {
    for (
      ...
      "object" == typeof handler && "function" == typeof handler.handleEvent
        ...
        : handler.call(e, a),
      !a.stoppedImmediatePropagation);
      s++
    );
    var u, c;
    return (
      (r = !a.stoppedPropagation),
      i && r && e.parentNode
        ? e.parentNode.dispatchEvent(a)
        : !a.defaultPrevented
    );
  }
  function r(e, t) {
  ...
  if (!document.createEvent) {
          ...
          for (var n in e)
            if (w.call(e, n))
              try {
                ...
                a.console &&
                  console.log(n + " failed on object:", t, e.message);
              }
        },
    ...
    e(a.HTMLCommentElement.prototype, b, "nodeValue"),
      ...
      m(
        ...
        "textContent",
        ((i = y(a.CSSStyleSheet.prototype, "cssText")),
        r(
          function () {
            ...
            return (
              ...
              a
                ? o.n
                  ? n.fireEvent(i, e)
                  : u(n, e, o.h, !0)
                : !(t = n.parentNode) || t.dispatchEvent(e),
              !e.defaultPrevented
            );
          },
        },
      ...
      v(a.HTMLDocument.prototype, {
        ...
        createEvent: {
          value: function (e) {
            ...
            return (
              ((t = document.createEventObject()).timeStamp =
                new Date().getTime()),
              t
            );
          },
            ...
            return (
              (n.prototype.getPropertyValue = function (e) {
                var t,
                  ...
                  s = r.runtimeStyle;
                return (
                  (e = ("float" === e ? "style-float" : e).replace(c, f)),
                  (t = a ? a[e] : o[e]),
                  l.test(t) &&
                    !u.test(e) &&
                    ((n = o.left),
            ...
            (o.noop = function () {}),
              ...
              (o.createElement = function (t, n, i) {
                try {
                  ...
                  for (var r in n)
                    n.hasOwnProperty(r) &&
                      ("css" === r ? o.css(e, n[r]) : o.attr(e, r, n[r]));
          ...
          function (e, t, n) {
            ...
            (t.exports = function (e, t, n, i) {
              ...
              var r = "obj" + ("" + Math.random()).slice(2, 15),
                o =
                  '<object class="fp-engine" id="' + r + '" name="' + r + '" ',
          ...
          function (e, t, n) {
            ...
            ((i = function (g, m) {
              var v,
                ...
                C = {
                    ...
                    if (e)
                      return (
                        !e.src ||
                          ...
                          g.conf.rtmp ||
                          e.rtmp ||
                          (e.src = E.createAbsoluteUrl(e.src)),
                        e
                      );
                  },
                  ...
                  load: function (n) {
                    ...
                    var t =
                        E.findDirect("video", m)[0] ||
                        E.find(".fp-player > video", m)[0],
                      i = n.src,
                      r = L(i),
                      o = function () {
                        E.removeNode(t);
                    ...
                    n.sources.some(function (e) {
                      ...
                      ? j.one(t, "timeupdate", o)
                      : o();
                    var a,
                      s = n.rtmp || I.rtmp;
                    if (
                      (r || s || (i = E.createAbsoluteUrl(i)),
                      w &&
                        A(n) &&
                        w.data !== E.createAbsoluteUrl(I.swfHls) &&
                        C.unload(),
                      w)
                    ) {
                      ...
                      m.getAttribute("data-origin") &&
                        (u.origin = m.getAttribute("data-origin")),
                        [
                          "proxy",
                          "key",
                          "autoplay",
                      ...
                      void 0 !== c &&
                        (u.hlsQualities = c
                          ...
                          : c),
                        void 0 !== I.bufferTime &&
                          (u.bufferTime = I.bufferTime),
                        void 0 !== I.bufferTimeMax &&
                          (u.bufferTimeMax = I.bufferTimeMax),
                        r && delete u.rtmp,
                        u.rtmp && (u.rtmp = e(u.rtmp));
                      var f,
                        d = I.bgcolor || E.css(m, "background-color") || "";
                      0 === d.indexOf("rgb")
                        ? (f = (function (e) {
                            function t(e) {
                      ...
                      E.prepend(h, w),
                        g
                          ...
                          .on("quality.flashengine", function (e, t, n) {
                            if (
                              void 0 !== g.video.hlsQualities
                                ? g.video.hlsQualities
                                : g.conf.hlsQualities
                            )
                              try {
                                w.__quality(n);
                        ...
                        M.push(
                          setTimeout(function () {
                            void 0 === w.PercentLoaded &&
                              g.trigger("flashdisabled", [g]);
                          }, 15e3)
                        ),
                        M.push(
                          setTimeout(function () {
                            void 0 === w.PercentLoaded &&
                              g.trigger("flashdisabled", [g, !1]);
                          }, 500)
                        ),
                        g
                        ...
                        (w.pollInterval = setInterval(function () {
                          if (w && !b) {
                            ...
                            e &&
                              ((g.conf.live || g.live || n.live) &&
                                ((n.seekOffset = e.seekOffset),
                                (n.duration = e.duration + e.seekOffset)),
                              g.playing &&
                                e.time &&
                                e.time !== g.video.time &&
                                g.trigger("progress", [g, e.time]),
                        ...
                        (window[y] = function (e, t) {
                          ...
                          switch (e) {
                            ...
                            case "status":
                              g.trigger("progress", [g, t.time]),
                                t.buffer < n.bytes && !n.buffered
                                  ? ((n.buffer =
                                      (t.buffer / n.bytes) * n.duration),
                                    g.trigger("buffer", n.buffer))
                                  : n.buffered ||
                                    ((n.buffered = !0), g.trigger("buffered"));
                              break;
                            case "metadata":
                              var r = atob(t);
                          ...
                          "click" === e || "keydown" === e
                            ? ((i.target = m), j.fire(m, e, [i]))
                            : "buffered" != e && "unload" !== e
                            ? setTimeout(function () {
                                g.trigger(i, [g, t]);
                              }, 1)
                            : "unload" === e && g.trigger(i, [g, t]);
                        });
                    }
                  },
                  speed: E.noop,
              ...
              (i.canPlay = function (e, t) {
                return (
                  (S.support.flashVideo && /video\/(mp4|flash|flv)/i.test(e)) ||
                  (S.support.flashVideo && t.swfHls && /mpegurl/i.test(e))
                );
              }),
              S.engines.push(i);
          },
          ...
          function (e, t, n) {
            ...
            ((l = function (d, a) {
              ...
              return r("hlsjs-lite", d, a, o, function (u, c, e) {
                ...
                var n,
                  r,
                  f = (d.engine.hls = new s(i));
                l.extensions.forEach(function (e) {
                  e({ hls: f, player: d, root: a, videoTag: c });
                }),
                  f.loadSource(u.src),
                  (e.resume = function () {
                    d.live &&
                      !d.dvr &&
                      (c.currentTime = f.liveSyncPosition || 0),
                      c.play();
                  }),
                  (e.seek = function (t) {
                    try {
                      d.live || d.dvr
                        ? (c.currentTime = Math.min(
                            t,
                            f.liveSyncPosition ||
                              c.duration - i.livePositionOffset
                          ))
                        : (c.currentTime = t);
                    } catch (e) {
                ...
                var o = function (e) {
                  ...
                  !n || 3e3 < t - n
                    ? ((n = performance.now()), f.recoverMediaError())
                    : (!r || 3e3 < t - r) &&
                      ((r = performance.now()),
                      f.swapAudioCodec(),
                      f.recoverMediaError());
                ...
                return (
                  f.on(s.Events.MANIFEST_PARSED, function (e, t) {
                    var i,
                      r = u.hlsQualities || d.conf.hlsQualities,
                      o = {},
                      n = t.levels;
                      ...
                      switch (n.length) {
                        ...
                        default:
                          i =
                            ...
                            (n[0].height &&
                              n[2].height &&
                              n[0].height === n[2].height)
                              ? []
                              : [1, 2];
                      }
                    if (
                      ((u.qualities = [{ value: -1, label: "Auto" }]),
                      Array.isArray(r))
                    ) {
                      ...
                      a
                        ...
                        (i = r.map(function (e) {
                          return (
                            void 0 !== e.level && (o[e.level] = e.label),
                  ...
                  f.on(s.Events.ERROR, function (e, t) {
                    if (t.fatal)
                      if (
                        i.recoverNetworkError &&
                        t.type === s.ErrorTypes.NETWORK_ERROR
                      )
                        o(!0);
                      else if (
                        i.recoverMediaError &&
                        t.type === s.ErrorTypes.MEDIA_ERROR
                      )
                        o(!1);
                      else {
                        var n = 5;
                  ...
                  }),
                  {
                    handlers: {
                      error: function (e, t) {
                        ...
                        return (i.recoverMediaError && 3 === n) || !n
                          ? (e.preventDefault(), o(!1), !0)
                          : i.recoverNetworkError && 2 === n
              ...
              return (
                !(!1 === t.hlsjs || (t.clip && !1 === t.clip.hlsjs)) &&
                !(
                  i.browser.safari &&
          ...
          function (e, t, n) {
            ...
            t.exports = function (e, d, p, h, l) {
              var t,
                ...
                c,
                f =
                  m.findDirect("video", p)[0] ||
                  m.find(".fp-player > video", p)[0],
                g = d.conf;
              return (c = {
                engineName: e,
                pick: function (e) {
                  ...
                  if (t)
                    return (
                      "string" == typeof t.src &&
                        (t.src = m.createAbsoluteUrl(t.src)),
                      t
                    );
                },
                load: function (e) {
                  ...
                  if (
                    ...
                    v.inlineVideo ||
                      m.css(f, { position: "absolute", top: "-9999em" }),
                    v.subtitles &&
                      g.nativesubtitles &&
                      e.subtitles &&
                      e.subtitles.length)
                    ...
                    i.some(function (e) {
                      ...
                      "function" == typeof f.textTracks.addEventListener &&
                        f.textTracks.addEventListener("addtrack", function () {
                      ...
                      try {
                        ...
                        if (e && e.catch) {
                          var t = function (e) {
                            ...
                            return (
                              d.debug("Play errored, trying muted", e),
                              d.mute(!0, !0),
                              f.play()
                            );
                          };
                  ...
                  if (
                    ((c._listeners =
                      (function (l, e, u, c) {
                        ...
                        if (!l.listeners || !l.listeners.hasOwnProperty(f)) {
                          ...
                          return (
                            l &&
                              l.textTracks &&
                              l.textTracks.length &&
                              Array.prototype.forEach.call(l.textTracks, n),
                            l &&
                              l.textTracks &&
                              "function" ==
                                typeof l.textTracks.addEventListener &&
                            ...
                            (d.conf.dvr || d.dvr || u.dvr) &&
                              y.on(l, "progress.dvrhack", function () {
                                l.seekable.length &&
                                  ((d.video.duration = l.seekable.end(null)),
                                  ...
                                  l.currentTime >= l.seekable.start(null) ||
                                    (l.currentTime = l.seekable.start(null)));
                              }),
                            Object.keys(b).forEach(function (a) {
                              var s = b[a];
                              if (
                                ("webkitendfullscreen" === a &&
                                  d.conf.disableInline &&
                                  (s = "unload"),
                                s)
                              ) {
                                var e = function (e) {
                                  if (
                                    ...
                                    if (
                                      (d.ready || /ready|error/.test(s)) &&
                                      s &&
                                      m.find("video", p).length
                                    )
                                      if ("unload" !== s) {
                                        switch (s) {
                                          case "ready":
                                            ...
                                            if (
                                              ...
                                              return void l.addEventListener(
                                                "timeupdate",
                                                r
                                              );
                                            }
                        ...
                        l.listeners[f] = u;
                      })(f, m.find("source", f).concat(f), e, o) ||
                      c._listeners),
                    !(g.autoplay || g.splash || e.autoplay))
                  ) {
                    var s = function () {
                      var e;
                      0 <= (e = p.getBoundingClientRect()).top &&
                        0 <= e.left &&
                        e.bottom <=
                          (window.innerHeight ||
                        ...
                        e.right <=
                          (window.innerWidth ||
                            ...
                            e.width &&
                        (d.debug("player is in viewport, preload"),
                ...
                unload: function () {
                  ...
                  delete f.listeners[e],
                    (f = 0),
                    c._listeners &&
                      Object.keys(c._listeners).forEach(function (t) {
        ...
        6: [
          function (e, t, n) {
            ...
            function l(e) {
              var t;
              return (
                /^(video|application)/i.test(e) ||
                  (e = /mpegurl/i.test((t = e)) ? "application/x-mpegurl" : t),
            ...
            ((i = function (e, t) {
              return a("html5", e, t, l, function (e, t) {
                t.currentSrc !== e.src
                  ? (o.find("source", t).forEach(o.removeNode),
                    (t.src = e.src),
                    (t.type = e.type))
                  : e.autoplay && t.load();
              });
            ...
            i(function (i, r) {
              ...
              if (t) {
                ...
                var s = function () {
                  ...
                  n = function (e, t, n) {
                    ((n = n || i.video), a && "undefined" != typeof _gat) &&
                      (s()._trackEvent(
                        "Video / Seconds played",
                        i.engine.engineName + "/" + n.type,
                        n.title ||
                          r.getAttribute("title") ||
                          n.src.split("/").slice(-1)[0].replace(l, ""),
                        Math.round(a / 1e3)
                      ),
                      (a = 0),
              ...
              if (!1 !== r.conf.chromecast) {
                ...
                m.on(o, "click", ".fp-chromecast", function (e) {
                  if ((e.preventDefault(), a))
                    return (
                      r.trigger("pause", [r]), a.stop(), (a = null), void h()
                    );
                  r.playing && r.pause(),
                    chrome.cast.requestSession(
                      function (e) {
                        ...
                        g.html(
                          g.find(".fp-chromecast-engine-status")[0],
                          "Playing on device " + t
                        );
                            ...
                            n.addUpdateListener(function (e) {
                              if (a) {
                                (s =
                                  ...
                                  e
                                    ? (g.toggleClass(o, "is-chromecast", !0),
                                ...
                                var t = n.playerState;
                                r.paused &&
                                  t === chrome.cast.media.PlayerState.PLAYING &&
                                  r.trigger("resume", [r]),
                                  r.playing &&
                                    t ===
                ...
                e === chrome.cast.ReceiverAvailability.AVAILABLE &&
                  (function () {
                    ...
                    r
                      ...
                      : g.prepend(g.find(".fp-player", o)[0] || o, t);
                  })();
              }
              function d() {}
              function p() {
          ...
          function (e, t, n) {
            ...
            i(function (a, s) {
              ...
              function c(e) {
                ...
                return (
                  t < 0 && (t = a.video.duration + t),
                  0.125 * Math.round(t / 0.125)
                );
              }
              a
                ...
                (a.removeCuepoint = function (t) {
                  "number" == typeof t &&
                    (t = a.cuepoints.filter(function (e) {
                      return e.index === t;
                    })[0]);
                ...
                l.append(e, t),
                  (a.embedCode = function () {
                    ...
                    return e.width || e.height
                      ? (isNaN(n) || (n += "px"),
                        isNaN(i) || (i += "px"),
                        o + "width:" + n + ";height:" + i + ';"></iframe>')
                      : ((r && !a.conf.adaptiveRatio) || (r = i / n),
                          ...
                          f
                            ? e
                              ? [
                                  ...
                                  "function" == typeof i[e] &&
                                    (i[e](Element.ALLOW_KEYBOARD_INPUT),
                    ...
                    t
                      ...
                      .on(c, function () {
                        ...
                        l.toggleClass(
                          n,
                          "fp-minimal",
                          l.hasClass(n, "fp-minimal-fullscreen")
                        ),
          ...
          function (e, t, n) {
            ...
            i(function (a, s) {
              (a.showMenu = function (e, t) {
                ...
                l.width(e) + o > l.width(n) &&
                  (o = o - l.width(e) + i.rightFallbackOffset),
                  l.height(e) + r > l.height(n) && (r -= l.height(e)),
                  l.css(e, { top: r + "px", left: o + "px", right: "auto" });
              }),
          ...
          function (e, t, n) {
            ...
            (v.touch || p) &&
              i(function (n, i) {
                ...
                if (t && !p) {
                  if ((!/Chrome/.test(y) && o < 4) || (e.samsung && o < 5)) {
                    ...
                    n.load = function () {
                      ...
                      return (
                        h.find("video.fp-engine", i)[0].load(),
                  ...
                  n.on("ready pause unload", function () {
                    ...
                    n.on("resume", function (e, t) {
                      if (t.live)
                        return l
                          ? u(t)
                          : void n.one("progress", function (e, t, n) {
                              0 === n && u(t);
                            });
                    });
                }
                v.volume ||
                  (h.removeClass(i, "fp-mute"), h.addClass(i, "no-volume")),
                  v.iOS && h.addClass(i, "fp-mute"),
                  h.addClass(i, "is-touch"),
                  n.sliders &&
                    n.sliders.timeline &&
                    n.sliders.timeline.disableAnimation();
                var c = !1;
                ...
                var f = !0;
                if (
                  (g.on(i, "touchend click", function (e) {
                    if (c) c = !1;
                    else {
                      var t = h.find("video.fp-engine", i)[0];
                      if (
                        (f &&
                          n.conf.clickToUnMute &&
                          t &&
                          t.muted &&
                          n.conf.autoplay &&
                          (t.muted = !1),
                      ...
                      n.playing ||
                        n.splash ||
                        !h.hasClass(i, "is-mouseout") ||
                        h.hasClass(i, "is-mouseover") ||
                        setTimeout(function () {
                          n.disabled ||
                            n.playing ||
                            n.splash ||
                            h.find("video.fp-engine", i)[0].play();
                        }, 400);
                    }
                  }),
                  !v.fullscreen &&
                    n.conf.native_fullscreen &&
                    "function" ==
                      typeof h.createElement("video").webkitEnterFullScreen)
                ) {
                  var d = n.fullscreen;
                  n.fullscreen = function () {
                    ...
                    n.trigger("fullscreen", [n]),
                      g.on(
                        ...
                        function () {
                          document.webkitFullscreenElement === e &&
                            (g.off(document, ".nativefullscreen"),
                            g.on(
                              document,
                              "webkitfullscreenchange.nativefullscreen",
                              function () {
                ...
                (t || r) &&
                  n.bind("ready", function () {
                    ...
                    n.conf.splash &&
                      t.paused &&
                      "hlsjs-lite" !== n.engine.engineName &&
                      (g.one(t, "canplay", function () {
                        t.play();
                      }),
                      t.load()),
            ...
            i(function (u, c) {
              ...
              function i() {
                ...
                if (!i) {
                  ...
                  e.length
                    ? e[0].parentElement.insertBefore(i, e[0])
                    : g.insertAfter(c, g.find("video", c)[0], i);
                }
                (i.innerHTML = ""),
                  u.conf.playlist[0].length &&
                    (u.conf.playlist = u.conf.playlist.map(function (e) {
                      if ("string" == typeof e) {
              ...
              g.toggleClass(c, "fp-custom-playlist", e),
                ...
                (u.play = function (e) {
                  ...
                  return (
                    u.off("beforeresume.fromfirst"),
                    "number" == typeof e && e === u.video.index
                      ? u.seek(0, function () {
                          u.resume();
                        })
                      : (u.load(t, function () {
                ...
                (u.next = function (e) {
                  ...
                  return (
                    -1 != t &&
                      ((t = t === u.conf.playlist.length - 1 ? 0 : t + 1),
                      u.play(t)),
                    u
                  );
                }),
                (u.prev = function (e) {
                  ...
                  return (
                    -1 != t &&
                      ((t = 0 === t ? u.conf.playlist.length - 1 : t - 1),
                      u.play(t)),
                    u
                  );
                }),
                (u.setPlaylist = function (e, t) {
                  return (
                    (u.conf.playlist = e), t || delete u.video.index, i(), u
                  );
                }),
                (u.addPlaylistItem = function (e) {
                  return (
                    delete u.video.is_last,
                ...
                u.off("finish.pl").on("finish.pl", function (e, t) {
                  if (void 0 === t.conf.advance || t.conf.advance) {
                    ...
                    n < t.conf.playlist.length || f.loop
                      ? ((n = n === t.conf.playlist.length ? 0 : n),
                        g.removeClass(c, "is-finished"),
                        setTimeout(function () {
                          t.play(n);
                        }))
                      : 1 < t.conf.playlist.length &&
                        (t.one("beforeresume.fromfirst", function (e) {
              ...
              var r = !1;
              u.conf.playlist.length &&
                ((r = !0),
                i(),
                (u.conf.clip && u.conf.clip.sources.length) ||
                  (u.conf.clip = u.conf.playlist[u.conf.startIndex || 0])),
                n().length &&
                  !r &&
                  ((u.conf.playlist = []),
                ...
                g
                  .find(".fp-prev,.fp-next,.fp-playlist", c)
                  .forEach(function (e) {
                    t.appendChild(e);
                  }),
                a.on(
                  v.test(f.query) ? document : c,
                  "click",
                  f.query,
                  function (e) {
                    e.preventDefault();
                    ...
                    if (u.conf.playlist.length) {
                      var i,
                        ...
                        a = (n.index =
                          void 0 !== (i = n).index
                            ? i.index
                            : void 0 !== u.video.index
                            ? u.video.index
                            : u.conf.startIndex || 0),
                        s = g.find(
                          f.query + '[data-index="' + a + '"]',
                          p()
                        )[0],
        ...
        21: [
          function (e, t, n) {
            ...
            function i(e) {
              ...
              return (
                (n = n.toLowerCase()),
                o(e.data(), { src: t, suffix: i || n, type: n || i })
              );
            }
            (t.exports = function () {
            ...
            i(function (t, e) {
              ...
              if (!1 !== n.share) {
                t.shareUrl = function (e) {
                  return e && n.embed && n.embed.iframe
                    ? n.embed.iframe
                    : "string" == typeof t.conf.share
                    ? t.conf.share
                    : (e
                      ...
                      encodeURIComponent(
                        t.video.title ||
                          (o.find("title")[0] || {}).innerHTML ||
                          "Flowplayer video"
                      ) +
                      "&c=" +
                      encodeURIComponent(
                        btoa(
                          JSON.stringify(a({}, t.conf, t.extensions)).replace(
                            /[\u007F-\uFFFF]/g,
                            function (e) {
                              return (
                                "\\u" +
                                ("0000" + e.charCodeAt(0).toString(16)).substr(
                                  -4
                                )
                              );
                            }
        ...
        23: [
          function (e, t, n) {
            ...
            (f.defaults.subtitleParser = i),
              f(function (r, o) {
                var a, s, n, l, i;
                (!f.support.inlineVideo ||
                  (!f.support.fullscreen && r.conf.native_fullscreen)) &&
                  (r.conf.nativesubtitles = !0),
                  r.ui || (r.ui = {}),
                ...
                r.on("ready", function (e, t, n) {
                  if (
                    ((t.subtitles = []),
                    (s =
                      (s = d.find(".fp-captions", o)[0]) ||
                      d.appendTo(
                        d.createElement("div", { class: "fp-captions" }),
                  ...
                  r.bind("cuepoint", function (e, t, n) {
                    n.subtitle
                      ? ((a = n.index), r.showSubtitle(n.subtitle.text))
                      : n.subtitleEnd && (r.hideSubtitle(), (a = n.index));
                  }),
                  r.bind("seek", function (e, t, i) {
                    a &&
                      r.cuepoints[a] &&
                      r.cuepoints[a].time > i &&
                      (d.removeClass(s, "fp-shown"), (a = null)),
                      (r.cuepoints || []).forEach(function (e, t) {
                        var n = e.subtitle;
                        n && a != t
                          ? i >= e.time &&
                            (!n.endTime || i <= n.endTime) &&
                            r.trigger("cuepoint", [r, e])
                          : e.subtitleEnd &&
                            i >= e.time &&
                            t == a + 1 &&
                            r.trigger("cuepoint", [r, e]);
                ...
                var u = function (e) {
                    d.toggleClass(d.find("a.fp-selected", l)[0], "fp-selected"),
                      d.toggleClass(
                        d.find('a[data-subtitle-index="' + e + '"]', l)[0],
                        "fp-selected"
                      );
                  },
                  c = function (e, t) {
                ...
                (r.disableSubtitles = function () {
                  return (
                    ...
                    u(-1),
                    f.support.subtitles &&
                      r.conf.nativesubtitles &&
                      "html5" == r.engine.engineName &&
                      c(null, "disabled"),
                    r
                  );
                }),
                      ...
                      if (
                        ...
                        return (
                          d.xhrGet(
                            ...
                            function () {
                              return (
                                r.trigger("error", { code: 8, url: t }), !1
                              );
                            }
                          ),
                          r
              ...
              var e = {},
                ...
                i =
                  ...
                  (n.indexOf("compatible") < 0 &&
                    /(mozilla)(?:.*? rv:([\w.]+)|)/.exec(n)) ||
                  [];
              i[1] && ((e[i[1]] = !0), (e.version = i[2] || "0")),
                e.safari &&
                  (e.version = (/version\/([\w.]+)/.exec(n) || [])[1]);
              var r,
                o,
                a =
                  (((o = document.createElement("video")).loop = !0),
                  (o.autoplay = !0),
                  (o.preload = !0),
                  o),
                ...
                m = /IEMobile/.test(s),
                v = m
                  ? parseFloat(/Windows\ Phone\ (\d+\.\d+)/.exec(s)[1], 10)
                  : 0,
                y = m ? parseFloat(/IEMobile\/(\d+\.\d+)/.exec(s)[1], 10) : 0,
                w =
                  u || f
                    ? (r = /iP(ad|hone)(; CPU)? OS (\d+_\d)/.exec(s)) &&
                      1 < r.length
                      ? parseFloat(r[r.length - 1].replace("_", "."), 10)
                      : 0
                    : 0,
                  ...
                  fullscreen:
                    "boolean" == typeof document.webkitFullscreenEnabled
                      ...
                      : ("function" == typeof document.webkitCancelFullScreen &&
                          !/Mac OS X 10_5.+Version\/5\.0\.\d Safari/.test(s)) ||
              ...
              try {
                var C = navigator.plugins["Shockwave Flash"],
                  A = l
                    ...
                    : C.description;
                l || C[0].enabledPlugin
                  ? ((A = A.split(/\D+/)).length && !A[0] && (A = A.slice(1)),
                    (M.flashVideo = 9 < A[0] || (9 == A[0] && 115 <= A[3])))
                  : (M.flashVideo = !1);
              } catch (e) {}
              try {
            ...
            (function (Z) {
              ...
              P(function (s, a) {
                ...
                k.find(".fp-ratio,.fp-ui", a).forEach(k.removeNode),
                  ...
                  a.appendChild(
                    k.createElement("div", { className: "fp-ratio" })
                  );
                var o = k.createElement(
                  "div",
                  { className: "fp-ui" },
                  '         <div class="fp-waiting">           {{ LOADING_SHARP_OUTLINE }}           {{ LOADING_SHARP_FILL }}           {{ LOADING_ROUNDED_FILL }}           {{ LOADING_ROUNDED_OUTLINE }}         </div>         <div class="fp-header">           <a class="fp-share fp-icon"></a>           <a class="fp-fullscreen fp-icon"></a>           <a class="fp-unload fp-icon"></a>         </div>         <p class="fp-speed-flash"></p>         <div class="fp-play fp-visible">           <a class="fp-icon fp-playbtn"></a>           {{ PLAY_ROUNDED_FILL }}           {{ PLAY_ROUNDED_OUTLINE }}           {{ PLAY_SHARP_FILL }}           {{ PLAY_SHARP_OUTLINE }}         </div>         <div class="fp-pause">           <a class="fp-icon fp-playbtn"></a>           {{ PAUSE_SHARP_OUTLINE }}           {{ PAUSE_SHARP_FILL }}           {{ PAUSE_ROUNDED_OUTLINE }}           {{ PAUSE_ROUNDED_FILL }}         </div>         <div class="fp-controls">            <a class="fp-icon fp-playbtn"></a>            <span class="fp-elapsed">00:00</span>            <div class="fp-timeline fp-bar">               <span class="fp-timestamp"></span>               <div class="fp-progress fp-color"></div>            </div>            <span class="fp-duration"></span>            <span class="fp-remaining"></span>            <div class="fp-volume">               <a class="fp-icon fp-volumebtn"></a>               <div class="fp-volumebar fp-bar-slider">                 <em></em><em></em><em></em><em></em><em></em><em></em><em></em>               </div>            </div>            <strong class="fp-speed fp-hidden"></strong>         </div>'
                    .replace("{{ PAUSE_ROUNDED_FILL }}", F)
                    .replace("{{ PAUSE_ROUNDED_OUTLINE }}", B)
                    .replace("{{ PAUSE_SHARP_FILL }}", H)
                    .replace("{{ PAUSE_SHARP_OUTLINE }}", V)
                    .replace("{{ PLAY_SHARP_OUTLINE }}", J)
                    .replace("{{ PLAY_SHARP_FILL }}", U)
                    .replace("{{ PLAY_ROUNDED_OUTLINE }}", O)
                    .replace("{{ PLAY_ROUNDED_FILL }}", W)
                    .replace("{{ LOADING_ROUNDED_OUTLINE }}", X)
                    .replace("{{ LOADING_ROUNDED_FILL }}", _)
                    .replace("{{ LOADING_SHARP_FILL }}", K)
                    .replace("{{ LOADING_SHARP_OUTLINE }}", Q)
                    .replace(
                      /url\(#/g,
                      "url(" +
                ...
                function S(e) {
                  k.css(i, "padding-top", 100 * e + "%"),
                    u.inlineBlock ||
                      k.height(k.find("object", a)[0], k.height(a));
                }
                function E(e) {
                  e
                    ? (k.addClass(a, "is-mouseover"),
                      k.removeClass(a, "is-mouseout"))
                    : (k.addClass(a, "is-mouseout"),
                ...
                s.on("dvrwindow", function () {
                  ...
                  s
                    ...
                    .on("buffer", function (e, t, n) {
                      ...
                      o.length !== n.length &&
                        (o.forEach(k.removeNode), (o = [])),
                        n.forEach(function (e, t) {
                          var n =
                            o[t] ||
                            k.createElement("div", { className: "fp-buffer" });
                          k.css(n, {
                    ...
                    .on("error", function (e, t, n) {
                      if (
                        ...
                        var r = t.message(
                          ((t.engine && t.engine.engineName) || "html5") +
                            ": " +
                            l.errors[i]
                        );
                        k.removeClass(a, "is-mouseover"),
                  ...
                  Y.on(a, "mouseleave", function () {
                    (w.dragging || M.dragging) &&
                      (k.addClass(a, "is-mouseover"),
                      k.removeClass(a, "is-mouseout"));
                  }),
                  Y.on(a, "click.player", function (e) {
                    if (!s.disabled)
                      return k.hasClass(e.target, "fp-ui") ||
                        k.hasClass(e.target, "fp-engine") ||
                        e.flash ||
                        k.hasParent(e.target, ".fp-play,.fp-pause")
                        ? (e.preventDefault && e.preventDefault(), s.toggle())
                        : void 0;
                  }),
                  Y.on(a, "mousemove", ".fp-timeline", function (e) {
                    var t = (e.pageX || e.clientX) - k.offset(y).left,
                      ...
                      r =
                        i.duration -
                        (void 0 === i.seekOffset ? 0 : i.seekOffset),
                      o = (s.rtl ? 1 - n : n) * r;
                    if (!(n < 0)) {
                      k.html(h, R(o));
                      var a = t - k.width(h) / 2;
                      a < 0 && (a = 0),
                        ...
                        !1 !== a
                          ? k.css(h, { left: a + "px", right: "auto" })
                          : k.css(h, { left: "auto", right: "0px" });
                    }
                  }),
                  ...
                  l.poster &&
                    k.css(a, "background-image", "url(" + l.poster + ")");
                var D,
                  N = k.css(a, "background-color"),
                  j =
                    "none" != k.css(a, "background-image") ||
                    (N && "rgba(0, 0, 0, 0)" != N && "transparent" != N);
                if (j && !l.splash) {
                  l.poster || (l.poster = !0);
                  var L = function () {
                    k.addClass(a, "is-poster"),
                      ...
                      s.on(
                        ...
                        function (e) {
                          ("beforeseek" === e.type || s.playing) &&
                            (k.removeClass(a, "is-poster"),
                            k.removeClass(m, "fp-visible"),
                            (s.poster = !1),
                            s.off(".poster"));
                        }
                ...
                if (
                  ("string" == typeof l.splash &&
                    k.css(a, "background-image", "url('" + l.splash + "')"),
                    ...
                    T = function () {
                      k.toggleClass(a, "is-tiny", x.clientWidth < 400),
                        k.toggleClass(
                          a,
                          "is-small",
                          x.clientWidth < 600 && 400 <= x.clientWidth
                        ),
        ...
        28: [
          function (e, t, n) {
            ...
            t.exports = function (a, e) {
              ...
              return (
                c.on(a, "mousedown.sld touchstart.sld", function (e) {
                  e.preventDefault(),
                    n ||
                      (i.slide(u(e), !0),
              ...
              var a,
                ...
                g = function (e, t) {
                  ...
                  return (
                    (!i || e <= i) &&
                      (f
                        ? y.removeClass(c, "animated")
                        : (y.addClass(c, "animated"),
        ...
        31: [
          function (e, t, n) {
                ...
                (b.forEach(function (e) {
                  e.conf.splash
                    ...
                    : e.bind("error", function () {
                        y.find(".flowplayer.is-error .fp-message").forEach(
                          y.removeNode
                        );
                      });
                }),
            ...
            if (void 0 !== window.jQuery) {
              var u = window.jQuery;
              u(function () {
                "function" == typeof u.fn.flowplayer &&
                  u(
            ...
            function c(e, t, n) {
              ...
              var d =
                (a.currentStyle && "rtl" === a.currentStyle.direction) ||
                (window.getComputedStyle &&
                  null !== window.getComputedStyle(a, null) &&
                  "rtl" ===
                    window
              ...
              var p = {
                ...
                load: function (e, t) {
                  if (!p.error && !p.loading) {
                    ...
                    if (
                      ((p.engine && n.engineName === p.engine.engineName) ||
                        ((p.ready = !1),
                        p.engine && (p.engine.unload(), (p.conf.autoplay = !0)),
                        (o = p.engine = n(p, a)),
                      ...
                      p.trigger("load", [p, e, o], !0).defaultPrevented
                        ? (p.loading = !1)
                        : ((p.ready = !1),
                          o.load(e),
                          m(e) && (t = e),
                ...
                pause: function (e) {
                  return p.hijacked
                    ? p.hijacked.pause(e) | p
                    : (!p.ready ||
                        p.seeking ||
                        p.loading ||
                        (o.pause(), p.one("pause", e)),
                      p);
                },
                resume: function () {
                  if (!p.trigger("beforeresume", [p], !0).defaultPrevented)
                    return p.hijacked
                      ...
                      : (p.ready &&
                          ...
                          (o.resume(),
                          p.finished &&
                            (p.trigger("resume", [p]), (p.finished = !1))),
                        p);
                },
                toggle: function () {
                  return p.ready
                ...
                seek: function (e, t) {
                  if ("boolean" == typeof e) {
                    var n = p.conf.seekStep || 0.1 * p.video.duration;
                    (e = p.video.time + (e ? n : -n)),
                      (e = Math.min(Math.max(e, 0), p.video.duration - 0.1));
                  }
                  if (void 0 === e) return p;
                  if (p.hijacked) return p.hijacked.seek(e, t) | p;
                  p.ready &&
                    ((r = e),
                    p.trigger("beforeseek", [p, e], !0).defaultPrevented
                      ? ((p.seeking = !1),
                        y.toggleClass(a, "is-seeking", p.seeking))
                      : (o.seek(e), m(t) && p.one("seek", t)));
                  return p;
                },
                seekTo: function (e, t) {
                  return void 0 === e
                    ? p.seek(r, t)
                    : void 0 !== p.video.seekOffset
                    ? p.seek(
                        p.video.seekOffset +
                          0.1 * (p.video.duration - p.video.seekOffset) * e,
                        t
                      )
                    : p.seek(0.1 * p.video.duration * e, t);
                },
                mute: function (e, t) {
                  return (
                    void 0 === e && (e = !p.muted),
                  ...
                  return (
                    p.ready &&
                      ("boolean" == typeof e &&
                        (e =
                          s.speeds[
                            s.speeds.indexOf(p.currentSpeed) + (e ? 1 : -1)
                          ] || p.currentSpeed),
                      o.speed(e),
                      t && a.one("speed", t)),
                    p
                ...
                disable: function (e) {
                  return (
                    void 0 === e && (e = !p.disabled),
                    e != p.disabled &&
                      ((p.disabled = e), p.trigger("disable", e)),
                    p
                  );
                },
                registerExtension: function (e, t) {
                ...
                if (s.engine) {
                  ...
                  if (
                    ...
                    e.sources.some(function (e) {
                      return (
                        (!e.engine || e.engine === t.engineName) &&
                        t.canPlay(e.type, p.conf)
                      );
                    })
                  )
                    return t;
                ...
                return (
                  s.enginePreference &&
                    (i = M.engines
                      ...
                      .sort(function (e, t) {
                        return (
                          s.enginePreference.indexOf(e.engineName) -
                          s.enginePreference.indexOf(t.engineName)
                        );
                      })),
                  e.sources.some(function (t) {
                    var e = i
                      .filter(function (e) {
                        return (
                          (!t.engine || t.engine === e.engineName) &&
                          e.canPlay(t.type, p.conf)
                        );
                      })
                      .shift();
                    return e && (n = e), !!e;
              ...
              return (
                a.getAttribute("data-flowplayer-instance-id") ||
                  (a.setAttribute("data-flowplayer-instance-id", C++),
                  p
                    .on("boot", function () {
                      var e = M.support;
                      (s.splash ||
                        y.hasClass(a, "is-splash") ||
                        !e.firstframe) &&
                        ((p.forcedSplash =
                          !s.splash && !y.hasClass(a, "is-splash")),
                        (p.splash = !0),
                        s.splash || (s.splash = !0),
                        y.addClass(a, "is-splash")),
                        s.splash && y.find("video", a).forEach(y.removeNode),
                        (s.dvr || s.live || y.hasClass(a, "is-live")) &&
                          ((p.live = s.live = !0),
                    ...
                    .on("load", function (e, t, n) {
                      s.splash &&
                        ...
                        y.addClass(a, "is-loading"),
                        (t.loading = !0),
                        (void 0 === n.live && void 0 === n.dvr) ||
                          (y.toggleClass(a, "is-live", n.dvr || n.live),
                    ...
                    .on("ready pause resume unload finish stop", function (e) {
                      (p.paused = /pause|finish|unload|stop/.test(e.type)),
                        (p.paused =
                          p.paused ||
                          ("ready" === e.type && !s.autoplay && !p.playing)),
                        (p.playing = !p.paused),
            ...
            e("./ext/support"),
              ...
              w(function (e, l) {
                var t,
                  ...
                  s = a.createElement,
                  u =
                    o.swf.indexOf("flowplayer.org") &&
                    o.e &&
                    l.getAttribute("data-origin"),
                  c = u
                    ? ((t = u),
                      ((n = document.createElement("a")).href = t),
                      a.hostname(n.hostname))
                    : a.hostname(),
                  f = (document, o.key);
                if (
                  ...
                  u &&
                    ((r = "is-embedded"),
                    -1 === (i = l).className.split(" ").indexOf(r) &&
                      (i.className += " " + r)),
          ...
          function (e, t, n) {
            ...
            (n.byteLength = function (e) {
              ...
              (n.toByteArray = function (e) {
                ...
                2 === r &&
                  ((t =
                    (f[e.charCodeAt(l)] << 2) | (f[e.charCodeAt(l + 1)] >> 4)),
                  (o[a++] = 255 & t));
                1 === r &&
                  ((t =
                    (f[e.charCodeAt(l)] << 10) |
              ...
              (r = function (e, t) {
                ...
                var g,
                  ...
                  z =
                    ...
                    (o = r.concat(
                      T("wheelDelta wheelDeltaX wheelDeltaY wheelDeltaZ axis")
                    )),
                    (a = i.concat(
                      T(
                    ...
                    (s = i.concat(T("data"))),
                    (l = i.concat(
                      T("touches targetTouches changedTouches scale rotation")
                    )),
                        ...
                        fix: function (e, t, n) {
                          return (
                            ...
                            e.pageX || e.pageY
                              ...
                              : (e.clientX || e.clientY) &&
                                ((t.clientX =
                                  e.clientX + E.body.scrollLeft + D.scrollLeft),
                                (t.clientY =
                                  e.clientY + E.body.scrollTop + D.scrollTop)),
                            h.test(n) &&
                              (t.relatedTarget =
                                e.relatedTarget ||
                                e[
                  ...
                  R =
                        ...
                        e = r
                          ? function (e) {
                              ...
                              if (r.apply(t, arguments))
                                return (
                                  e && (e.currentTarget = t), a(e, arguments)
                                );
                            }
                          : function (e) {
                              return (
                                i.__beanDel && (e = e.clone(s(e))),
                                a(e, arguments)
                              );
                            };
                    ...
                    ((n = function (e, t, n, i, r, o, a) {
                      ...
                      "unload" == t && (n = B(F, e, t, n, i)),
                        l &&
                          (l.condition && (n = u(e, n, l.condition, o)),
                          (t = l.base || t)),
                  ...
                  O =
                    ...
                    }),
                    {
                      ...
                      put: function (e) {
                        var t =
                            !e.root && !this.has(e.element, e.type, null, !1),
                          n = (e.root ? "r" : "$") + e.type;
                  ...
                  H = N
                    ...
                    : function (e, t, n) {
                        (n = G(n, e)),
                          e
                            ? n.fireEvent("on" + t, E.createEventObject())
                            : n["_on" + t]++;
                      },
                  V = function (e, t, n) {
                    var i,
                    ...
                    if (
                      ((r = s && t.replace(A, "")) && Y[r] && (r = Y[r].base),
                      !t || s)
                    )
                      (o = s && t.replace(C, "")) && (o = T(o, ".")),
                        F(e, r, n, o);
                    else if (P(t)) F(e, null, t);
                    else for (i in t) t.hasOwnProperty(i) && V(e, i, t[i]);
                    return e;
                  },
                  X = function (e, t, n, i) {
                    var r, o, a, s, l, u, c;
                  ...
                  _ = {
                    ...
                    add: function (e, t, n, i) {
                      return X.apply(
                        ...
                        Z(n)
                          ? [e, n, t, i].concat(
                              3 < arguments.length ? x.call(arguments, 5) : []
                            )
                          : x.call(arguments)
                      );
                    },
            ...
            (function (e) {
                ...
                return "undefined" != typeof ArrayBuffer &&
                  ...
                  : (function (e, t) {
                      if (f.isBuffer(t)) {
                        var n = 0 | d(t.length);
                        return (
                          0 === (e = s(e, n)).length || t.copy(e, 0, 0, n), e
                        );
                      }
                      if (t) {
                        if (
              ...
              (f.prototype.slice = function (e, t) {
                ...
                (f.prototype.readUInt16LE = function (e, t) {
                  return (
                    t || E(e, 2, this.length), this[e] | (this[e + 1] << 8)
                  );
                }),
                (f.prototype.readUInt16BE = function (e, t) {
                  return (
                    t || E(e, 2, this.length), (this[e] << 8) | this[e + 1]
                  );
                }),
            ...
            !(function (e, t) {
              ...
              var L,
                ...
                z = function (e) {
                  var t, n, i;
                  if (P(e)) return e;
                  if (((n = e.valueOf), D(n) && ((t = n.call(e)), P(t))))
                    return t;
                  if (((i = e.toString), D(i) && ((t = i.call(e)), P(t))))
                    return t;
                  throw new TypeError();
                },
                G = function (e) {
                ...
                e,
                {
                  forEach: function (e) {
                    var t,
                      ...
                      r = -1,
                      o = R(i.length);
                    if ((1 < arguments.length && (t = arguments[1]), !D(e)))
                      throw new TypeError(
                        "Array.prototype.forEach callback must be a function"
                      );
                    for (; ++r < o; )
                      r in i &&
                        (void 0 === t ? e(i[r], r, n) : e.call(t, i[r], r, n));
                  },
                },
                !ie(e.forEach)
              ),
                  ...
                  e,
                  {
                    filter: function (e) {
                      var t,
                        ...
                        o = R(r.length),
                        a = [];
                      if ((1 < arguments.length && (n = arguments[1]), !D(e)))
                        throw new TypeError(
                      ...
                      for (var s = 0; s < o; s++)
                        s in r &&
                          ((t = r[s]),
                          (void 0 === n ? e(t, s, i) : e.call(n, t, s, i)) &&
                            K(a, t));
                      return a;
                    },
                  },
                  ...
                  e,
                  {
                    some: function (e) {
                      ...
                      for (var o = 0; o < r; o++)
                        if (
                          o in i &&
                          (void 0 === t ? e(i[o], o, n) : e.call(t, i[o], o, n))
                        )
                          return !0;
                      return !1;
                    },
              ...
              e.reduce &&
                (re =
                  "object" ==
                  typeof e.reduce.call("es5", function (e, t, n, i) {
                    return i;
                  })),
                Z(
                  e,
              ...
              e.reduceRight &&
                (oe =
                  "object" ==
                  typeof e.reduceRight.call("es5", function (e, t, n, i) {
                    return i;
                  })),
                Z(
                  e,
              ...
              Z(
                e,
                {
                  indexOf: function (e) {
                    ...
                    var i = 0;
                    for (
                      1 < arguments.length && (i = Y(arguments[1])),
                        i = 0 <= i ? i : b(0, n + i);
                      i < n;
                      i++
                    )
              ...
              Z(
                e,
                {
                  lastIndexOf: function (e) {
                    ...
                    var i = n - 1;
                    for (
                      1 < arguments.length && (i = I(i, Y(arguments[1]))),
                        i = 0 <= i ? i : n - Math.abs(i);
                      0 <= i;
                      i--
                    )
              ...
              var fe,
                de = ((fe = {}), e.splice.call(fe, 0, 0, 1), 1 === fe.length);
              Z(
                e,
                {
                  splice: function (e, t) {
                    ...
                    var n = arguments;
                    return (
                      (this.length = b(Y(this.length), 0)),
                      0 < arguments.length &&
                        "number" != typeof t &&
                        ((n = J(arguments)).length < 2
                          ? K(n, this.length - e)
                          : (n[1] = Y(t))),
                      o.apply(this, n)
                    );
              ...
              var be,
                ...
                Me =
                  ((be = {}),
                  1 !== Array.prototype.push.call(be, void 0) ||
                    1 !== be.length ||
                    void 0 !== be[0] ||
                    !W(be, 0));
              Z(
              ...
              var Ne = !Q({ toString: null }, "toString"),
              ...
              Z(
                ...
                (Je || Ue) &&
                  ...
                  T &&
                    l.defineProperty(Date.prototype, "toString", {
                      configurable: !0,
                      enumerable: !1,
                      writable: !0,
                    }));
              var st = -621987552e5,
                ...
                ut =
                  ...
                  -1 === new Date(st).toISOString().indexOf(lt),
                ct =
                  Date.prototype.toISOString &&
              ...
              Z(
                Date.prototype,
                {
                  toISOString: function () {
                    ...
                    e =
                      (e < 0 ? "-" : 9999 < e ? "+" : "") +
                      V("00000" + Math.abs(e), 0 <= e && e <= 9999 ? -4 : -6);
                ...
                (function () {
                  try {
                    return (
                      ...
                      -1 !== new Date(st).toJSON().indexOf(lt) &&
              ...
              if (isNaN(Date.parse("2000-01-01T00:00:00.000Z")) || pt || !dt) {
                ...
                Date = (function (h) {
                  ...
                  Z(p, { now: h.now, UTC: h.UTC }, !0),
                    (p.prototype = h.prototype),
                    Z(p.prototype, { constructor: p }, !0);
                  return (
                    Z(p, {
                      parse: function (e) {
                        var t = g.exec(e);
              ...
              Z(
                r,
                {
                  toFixed: function (e) {
                    var t, n, i, r, o, a, s, l;
                    if (
                      ((t = y(e)), (t = k(t) ? 0 : Math.floor(t)) < 0 || 20 < t)
                    )
                      throw new RangeError(
                    ...
                    if (
                      ...
                      if (
                        ((a =
                          (o = vt.log(n * vt.pow(2, 69, 1)) - 69) < 0
                            ? n * vt.pow(2, -o, 1)
                            : n / vt.pow(2, o, 1)),
                        (a *= 4503599627370496),
                        0 < (o = 52 - o))
                      ) {
                        for (vt.multiply(0, a), s = t; 7 <= s; )
                          vt.multiply(1e7, 0), (s -= 7);
                        for (
                          vt.multiply(vt.pow(10, s, 1), 0), s = o - 1;
                          23 <= s;
                    ...
                    return (r =
                      0 < t
                        ? (l = r.length) <= t
                          ? i + V("0.0000000000000000000", 0, t - l + 2) + r
                          : i + V(r, 0, l - t) + "." + V(r, l - t)
                        : i + r);
                  },
                },
              ...
              1 === Mt.length && void 0 === Mt[0]) ||
                (i.replace = function (r, o) {
                  var e = D(o),
                    t = d(r) && /\)[*?]/.test(r.source);
                  if (e && t) {
              ...
              Z(
                i,
                {
                  substr: function (e, t) {
                    var n = e;
                    return (
                      e < 0 && (n = b(this.length + e, 0)), At.call(this, n, t)
                    );
                  },
                },
                St
              ...
              var xt = m.bind(String.prototype.trim),
                Tt = i.lastIndexOf && -1 !== "abcã‚ã„".lastIndexOf("ã‚ã„", 2);
              Z(
                i,
                {
                  lastIndexOf: function (e) {
                    ...
                    for (
                      var t = v(this),
                        n = v(e),
                        i = 1 < arguments.length ? y(arguments[1]) : NaN,
                        r = k(i) ? 1 / 0 : Y(i),
                        o = I(b(r, 0), t.length),
                        a = n.length,
                        s = o + a;
              ...
              !(function (e) {
                ...
                function g(e) {
                  var t,
                    ...
                    g = M,
                    m = I;
                  for ((n = e.lastIndexOf(C)) < 0 && (n = 0), i = 0; i < n; ++i)
                    ...
                    for (
                      ...
                      p <= r && E("invalid-input"),
                        ...
                        (y <=
                          ...
                          E("overflow"),
                        (h += l * a),
                        !(l < (u = s <= m ? w : m + b <= s ? b : s - m));
                      s += y
                    )
                      a > A(v / (c = y - u)) && E("overflow"), (a *= c);
                ...
                function m(e) {
                  ...
                  for (i = r = m.length, r && m.push(C); i < d; ) {
                    ...
                    for (
                      ...
                      if (
                        ((f = e[a]) < t && ++n > v && E("overflow"), f == t)
                      ) {
                        for (
                          l = n, u = y;
                          !(l < (c = u <= o ? w : o + b <= u ? b : u - o));
                          u += y
                        )
                          (g = l - c),
                            (h = y - c),
                ...
                if (
                  ...
                  else for (o in r) r.hasOwnProperty(o) && (t[o] = r[o]);
                else e.punycode = r;
              })(this);
            }.call(
              this,
